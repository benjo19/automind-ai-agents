...
export const translations = {
  hr: {
    ...
    faq: {
      ...
      items: [
        ["Što je Automind?", "Automind je AI recepcionar za lokalne tvrtke u Hrvatskoj — odgovara na pozive, poruke i web upite, zakazuje termine i šalje ponude 24/7."],
        ["Za koga je Automind namijenjen?", "Za salone, ordinacije, auto servise, praonice rublja, majstore, agencije i druge male i srednje tvrtke koje primaju mnogo upita."],
