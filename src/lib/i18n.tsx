...
export const translations = {
  hr: {
    nav: {
      ...
      cta: "Besplatna procjena procesa",
      openMenu: "Otvori meni",
      logoLabel: "Automind - povratak na vrh",
      languageLabel: "Promijeni jezik",
    },
    seo: {
      title: "AutoMind AI – automatizacije i aplikacije po mjeri",
      description: "Automatiziramo upite, rezervacije, prodaju, narudžbe i administraciju te izrađujemo aplikacije po mjeri vašeg poslovnog procesa.",
      keywords: "automatizacija poslovanja, AI Hrvatska, aplikacije po mjeri, integracije, AI recepcionar, CRM, prodajni follow-up",
      orgDescription: "Automatizacije, AI i aplikacije po mjeri za stvarne poslovne procese",
    },
    hero: {
      badges: ["Automatizacije i integracije", "AI recepcionar i komunikacija", "Aplikacije po mjeri", "Bez nepotrebne složenosti"],
      tagline: "AUTOMATIZACIJE • AI • APLIKACIJE PO MJERI",
      title: "Vaš posao ne treba još jedan alat. Treba sustav koji radi za vas.",
      description: "Automatiziramo upite, rezervacije, prodaju, narudžbe i administraciju. Kada gotovi alati nisu dovoljni, izrađujemo aplikacije prema vašem procesu.",
      primaryCta: "Besplatna procjena procesa",
      secondaryCta: "Kako radimo",
      proof: "Od jedne automatizacije do kompletne interne aplikacije — prema stvarnom procesu vašeg poslovanja.",
    },
    concreteActions: {
      titleStart: "Što možemo napraviti",
      titleHighlight: "za vaše poslovanje?",
      actions: [
        ["AI recepcionar i komunikacija", "Odgovori na upite, kvalifikacija leadova, rezervacije i osnovna korisnička podrška 24/7."],
        ["Prodaja i follow-up", "Automatski odgovor na lead, podsjetnici, follow-up i prijenos podataka u CRM ili tablicu."],
        ["Automatizacije i integracije", "Povezujemo e-mail, kalendar, forme, baze, CRM, dokumente i interne procese u jedan tijek."],
        ["Individualne aplikacije po mjeri", "Gradimo aplikaciju prema vašem procesu: korisnici, odjeli, narudžbe, dashboardi, odobrenja i izvještaji."],
        ["Dashboardi i izvještaji", "Jasniji pregled procesa, statusa i podataka za kvalitetnije odluke."],
      ],
    },
    targetIndustries: {
    ...
    demoForm: {
      titleStart: "Besplatna procjena",
      titleHighlight: "procesa",
      subtitle: "Pošaljite nam kako danas radite — predložit ćemo što se isplati automatizirati.",
      step1: "1. Vaši podaci",
      ...
      interests: ["AI recepcionar i komunikacija", "Prodaja i follow-up", "Automatizacije i integracije", "Aplikacija po mjeri", "Dashboardi i izvještaji"],
      deadline: "Željeni rok implementacije",
      deadlinePlaceholder: "npr. odmah, za 2 tjedna, sljedeći mjesec...",
      message: "Dodatna poruka",
      messagePlaceholder: "Opišite kako danas radite i gdje gubite najviše vremena...",
    ...
    services: {
      title: "Što možemo napraviti za vaše poslovanje",
      subtitle: "Od jedne automatizacije do kompletne interne aplikacije — bez nepotrebne složenosti.",
      imageAlt: "Profesionalno rješenje za vaš posao",
      cards: [
        { title: "AI recepcionar i komunikacija", description: "Upiti, rezervacije, leadovi i osnovna korisnička podrška 24/7.", features: ["Komunikacija na webu i porukama", "Pozivi i sažeci zahtjeva", "Prebacivanje na čovjeka"] },
        { title: "Prodaja i follow-up", description: "Automatski odgovor na lead, podsjetnici i praćenje prodajnog procesa.", features: ["Pravovremeni follow-up", "Ponude prema vašem procesu", "Pregled klijenata na jednom mjestu"] },
        { title: "Automatizacije i aplikacije po mjeri", description: "Povezani alati i interna rješenja prilagođena načinu na koji radite.", features: ["Integracije alata i podataka", "Aplikacije za stvarne procese", "Dashboardi i izvještaji"] },
      ],
    },
    solutions: {
      titleStart: "Rješenja",
      titleHighlight: "prema vašem procesu",
      subtitle: "Nema generičkog rješenja ako vaš proces nije generički.",
      learnMore: "Saznaj više",
      cards: [
        ["Komunikacija i rezervacije", "Odgovori na upite, rezervacije i prijenos pravih zahtjeva vašem timu."],
        ["Prodajni proces", "Leadovi, ponude i follow-up povezani u jedan pregledan tijek."],
        ["Integracije", "E-mail, kalendar, forme, CRM, dokumenti i baze povezani bez ručnog prepisivanja."],
        ["Aplikacije po mjeri", "Korisnici, odjeli, narudžbe, odobrenja, dashboardi i AI funkcije prema vašim potrebama."],
      ],
    },
    howItWorks: {
      titleStart: "Kako",
      titleHighlight: "radimo",
      subtitle: "Prvo razumijemo kako radite. Tek onda predlažemo rješenje koje ima poslovnog smisla.",
      steps: [
        ["Razumijemo proces", "Upoznajemo kako danas radite, gdje gubite vrijeme i što se isplati automatizirati."],
        ["Predložimo rješenje", "Predlažemo automatizaciju, integraciju ili aplikaciju koja odgovara vašem poslovanju."],
        ["Izradimo i povežemo", "Izrađujemo rješenje, povezujemo ga s vašim alatima te testiramo i optimiziramo rad."],
      ],
    },
    beforeAfter: {
      titleStart: "Prije i",
    ...
    faq: {
      ...
      subtitle: "Odgovori o automatizacijama, integracijama i aplikacijama po mjeri.",
      items: [
        ["Što je AutoMind AI?", "AutoMind AI izrađuje automatizacije, integracije i aplikacije po mjeri stvarnog procesa vašeg poslovanja."],
        ["Radite li samo AI recepcionare?", "Ne. AI recepcionar je samo jedno moguće rješenje; radimo i prodajne follow-upove, integracije, interne procese, dashboarde i aplikacije po mjeri."],
        ["Kako AI recepcionar zakazuje termine?", "Povezujemo ga s vašim kalendarom — AI provjerava slobodne termine i potvrđuje ih klijentu u realnom vremenu, bez vašeg uplitanja."],
        ["Razumije li hrvatski jezik?", "Da. Svi naši agenti razumiju i odgovaraju na prirodnom hrvatskom jeziku, s pravilnim sklonidbama i lokalnim izrazima."],
        ["Može li odgovarati na pozive?", "Da. AI voice recepcionar javlja se na pozive, razgovara s klijentom, hvata podatke i šalje vam sažetak — sve u stvarnom vremenu."],
        ["Što s upitima izvan radnog vremena?", "AI radi 24/7. Klijenti dobivaju trenutni odgovor i mogu rezervirati termin u bilo koje doba dana ili noći."],
        ["Kako šalje ponude?", "Iz upita generira ponudu na temelju vašeg cjenika i šalje ju klijentu na e-mail ili WhatsApp — automatski ili nakon vašeg odobrenja."],
        ["Koliko dugo traje postavljanje?", "Standardno aktiviramo sustav unutar 7 dana od pokretanja projekta."],
        ["Trebam li tehničko znanje?", "Ne. Mi sve postavljamo i predajemo gotovo rješenje. Vi samo koristite."],
        ["Mogu li nadzirati razgovore?", "Da. Imate uvid u sve razgovore, leadove i statuse u jednoj nadzornoj ploči."],
        ["Što ako AI ne zna odgovor?", "Sustav klijenta prebacuje na vas ili šalje obavijest da ručno odgovorite — nijedan upit ne ostaje bez odgovora."],
        ["Povezuje li se s mojim alatima?", "Da. Integriramo se s kalendarima, CRM-om, e-mailom, WhatsAppom i sustavima za fakturiranje."],
        ["Je li sigurno za podatke klijenata?", "Da. Infrastruktura je u EU, podaci su šifrirani, sve je usklađeno s GDPR-om."],
        ["Koliko košta?", "Imamo jednostavan mjesečni paket prilagođen vašoj veličini. Pošaljemo personaliziranu ponudu nakon kratkog razgovora."],
        ["Postoji li ugovor ili obveza?", "Nema dugoročnih obveza. Sve uvjete dogovaramo jasno prije početka."],
        ["Što ako želim prilagodbe?", "Sve je prilagodljivo — ton, scenariji, jezik, integracije. Mijenjamo prema vašim potrebama bez dodatnih troškova u sklopu paketa."],
        ["Mogu li probati prije nego se odlučim?", "Da. Pripremamo besplatni demo prilagođen vašoj djelatnosti — vidite kako bi izgledalo u praksi."],
        ["Što ako moja djelatnost nije navedena?", "Sustav radi za bilo koju lokalnu uslužnu djelatnost. Javite nam — pripremamo prijedlog rješenja."],
        ["Mogu li koristiti više kanala odjednom?", "Da. AI istovremeno radi na web chatu, telefonu, WhatsAppu, Instagramu i e-mailu."],
        ["Kako započeti?", "Kliknite Zatraži demo i javimo se u roku 24 sata s prijedlogom prilagođenim vašoj tvrtki."],
      ],
    },
    footer: {
      tagline: "Automatizacije, AI i aplikacije po mjeri za stvarne poslovne procese.",
      contact: "Kontakt",
      legal: "Pravno",
    ...
    install: {
      titleMeta: "Instaliraj Automind aplikaciju",
      eyebrow: "Automind aplikacija",
      title: "Instaliraj Automind na svoj mobitel.",
      text: "Dodaj Automind na početni ekran i otvaraj stranicu kao aplikaciju, bez traženja linka u browseru.",
      iosTitle: "iPhone / iPad",
      iosSteps: ["Otvori stranicu u Safari browseru.", "Dodirni Share ikonu.", "Odaberi Add to Home Screen i potvrdi Add."],
      androidTitle: "Android / Chrome",
      androidSteps: ["Otvori stranicu u Chrome browseru.", "Dodirni izbornik s tri točkice.", "Odaberi Install app ili Add to Home screen."],
  ...
  en: {
    ...
    install: {
      titleMeta: "Install the Automind app",
      eyebrow: "Automind app",
      title: "Install Automind on your phone.",
      text: "Add Automind to your home screen and open the site like an app, without searching for the link in your browser.",
      iosTitle: "iPhone / iPad",
      iosSteps: ["Open the site in Safari.", "Tap the Share icon.", "Choose Add to Home Screen and confirm Add."],
      androidTitle: "Android / Chrome",
      androidSteps: ["Open the site in Chrome.", "Tap the three-dot menu.", "Choose Install app or Add to Home screen."],
      back: "Back to start",
    },
    chat: {
