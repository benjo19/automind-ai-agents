        ...
        <ScrollReveal>
          <div className="glass-card p-8 md:p-12 max-w-4xl mx-auto text-center overflow-hidden relative">
            ...
            <h2 className="font-playfair text-3xl md:text-5xl font-bold mb-4 tracking-tight">
              Koliko vas košta <span className="gradient-text-rainbow">propušten klijent?</span>
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Ako vam samo 3 klijenta mjesečno ne dobiju odgovor na vrijeme, već gubite više nego što košta automatizacija.
            </p>
            <Button variant="hero" size="lg" onClick={scrollToDemo} className="group">
              Želim provjeriti koliko upita gubim
